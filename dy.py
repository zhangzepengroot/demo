...
def wssServerStart(roomId):
    ...
    current_milliseconds = str(round(time.time() * 1000))
    now = datetime.datetime.utcnow()
    formatted_time = now.strftime('%a, %d %b %Y %H:%M:%S GMT')
    webSocketUrl = 'wss://webcast3-ws-web-hl.douyin.com/webcast/im/push/v2/?app_name=douyin_web&version_code=180800&webcast_sdk_version=1.3.0&update_version_code=1.3.0&compress=gzip&internal_ext=internal_src:dim|wss_push_room_id:'+liveRoomId+'|wss_push_did:7225435754208626216|dim_log_id:20230525141128A8140A325E47CE17894B|fetch_time:'+current_milliseconds+'|seq:1|wss_info:0-1684995088711-0-0|wrds_kvs:WebcastRoomRankMessage-1684994008963392865_InputPanelComponentSyncData-1684993688331095222_WebcastRoomStatsMessage-1684995070902163573&cursor=u-1_h-1_t-1684995088711_r-1_d-1&host=https://live.douyin.com&aid=6383&live_id=1&did_rule=3&debug=true&maxCacheMessageNumber=20&endpoint=live_pc&support_wrds=1&im_path=/webcast/im/fetch/&user_unique_id=7225435754208626216&device_platform=web&cookie_enabled=true&screen_width=1440&screen_height=900&browser_language=zh-CN&browser_platform=MacIntel&browser_name=Mozilla&browser_version=5.0%20(Macintosh;%20Intel%20Mac%20OS%20X%2010_15_7)%20AppleWebKit/537.36%20(KHTML,%20like%20Gecko)%20Chrome/112.0.0.0%20Safari/537.36&browser_online=true&tz_name=Asia/Shanghai&identity=audience&room_id='+liveRoomId+'&heartbeatDuration=0&signature=W/8d2lz5ZPgy+xwZ'
    h = {
        'cookie': 'ttwid='+ttwid+'; Domain=.douyin.com; Path=/; Expires='+formatted_time+'; HttpOnly; SameSite=None; Secure=true',
